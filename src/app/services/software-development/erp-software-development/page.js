            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                    ERP Software<span>Development.</span>
                  </h2>
                  <p>
                    Empower Your Business with Custom ERP Solutions: Unlock
                    efficiency, streamline operations, and harness the full
                    potential of your enterprise with our cutting-edge ERP
                    software solutions. Designed to integrate seamlessly into
                    your existing workflows, our ERP software offers customized
                    tools that adapt to your industry's unique challenges and
                    growth aspirations.
                    <br></br>
                    <br></br>
                    The Backbone of Modern Enterprises: Enterprise Resource
                    Planning (ERP) software is an integrated management system
                    that helps streamline and automate core business processes,
                    including inventory management, human resources, finance,
                    and customer relationship management. By centralizing data
                    and processes, ERP software reduces complexities and
                    enhances decision-making, leading to improved productivity
                    and efficiency.
                  </p>
                </div>
              </div>
