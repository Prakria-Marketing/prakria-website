            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  ...
                  <p>
                    We enable organizations by developing custom software
                    solutions that make use of state-of-the-art technology and
                    follow industry best practices. As a result, they may
                  ...
                  <ul className="key-features">
                    <li>
                      ...
                      <Link href="/services/software-development/erp-software-development">ERP Software Development</Link>
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="/services/software-development/custom-crm-development">Custom CRM Development</Link>
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="/services/software-development/sap-software-development">SAP Software Development</Link>
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="/services/software-development/accounting-software-development"> Accounting Software Development</Link>
                    </li>
                  </ul>
                </div>
              </div>
