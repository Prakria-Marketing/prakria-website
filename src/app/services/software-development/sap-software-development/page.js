            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                    SAP Software<span>Development.</span>
                  </h2>
                  <p>
                    Unlock Your Business Potential with Expert SAP Software
                    Development<br></br>
                    In the dynamic world of business technology, SAP stands out
                    as a robust enterprise resource planning (ERP) system that
                    drives efficiency and growth. At PRAKRIA, we specialize in
                    custom SAP software development tailored to fit your
                    specific business needs, empowering you to optimize your
                    operations and enhance your competitive edge.<br></br>
                    <br></br>
                    At PRAKRIA, we pride ourselves on our deep industry
                    knowledge and technical expertise in SAP software
                    development. Our team is dedicated to delivering solutions
                    that not only meet your specifications but also exceed your
                    expectations in terms of functionality, scalability, and
                    reliability.
                  </p>
                </div>
              </div>
