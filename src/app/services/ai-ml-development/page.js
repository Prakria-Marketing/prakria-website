                ...
                <div className="service-details-top-content">
                  ...
                  <ul className="key-features">
                    <li>
                     ...
                     <Link href="/services/ai-ml-development/artificial-intelligence-development"> AI Development</Link>
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="/services/ai-ml-development/ai-consulting">AI Consulting</Link>
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="/services/ai-ml-development/chatbot-development">Chatbot Development</Link>
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="/services/ai-ml-development/adaptive-ai">Adaptive AI</Link>
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="/services/ai-ml-development/ml-development">ML Development</Link>
                    </li>
                    <li>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Link href="/services/ai-ml-development/generative-ai">Generative AI</Link>
                    </li>
                  </ul>
                </div>
              </div>
