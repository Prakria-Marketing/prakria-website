            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                    Metaverse <span>NFT.</span>
                  </h2>
                  <p>
                    Utilize Prakria's cutting-edge Metaverse NFT marketplace
                    creation services in the USA and India to create
                    specialized, safe, and scalable NFT marketplaces in the
                    Metaverse. We realize your metaverse NFT marketplace concept
                    with our extensive knowledge of the metaverse and blockchain
                    skills.
                  </p>
                  <h6>Development Company for the Metaverse NFT Marketplace</h6>
                  <p>
                    You may rely on Prakria, a top Metaverse NFT marketplace
                    development business in the USA and India, to create
                    Metaverse NFT marketplaces that are prepared for the future.
                    Our markets enable the borderless trading of digital assets
                    and tokens in a highly immersive environment for startups,
                    small enterprises, and Fortune 500 companies.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="service-details-img">
                  <img
                    src="/assets/img/innerservices/metaverse-nft/1.jpg"
            ...
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-6">
                <div className="service-details-faq-img">
                  <img
                    src="/assets/img/innerservices/metaverse-nft/2.jpg"
                    alt="ai & ml development"
                  />
                </div>
              </div>
