            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                    Blockchain App <span>Development.</span>
                  </h2>
                  <p>
                    With Prakria's comprehensive blockchain development
                    services, you can lead the way in blockchain technology.
                    ...
                    industry leader in the blockchain space.<br></br>
                    <br></br>
                    Prakria is the answer to your search! We make the most of
                    our technological prowess, product mentality, and experience
                    to provide clients with an unparalleled experience that is
              ...
              >
                <div className="service-details-img">
                  <img
                    src="/assets/img/innerservices/blockchain/2.jpg"
            ...
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-6">
                <div className="service-details-faq-img">
                  <img
                    src="/assets/img/innerservices/blockchain/1.jpg"
                    alt="blockchain development"
                  />
                </div>
              </div>
