            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                  React Native <span>App Development.</span>
                  </h2>
                  <p>
                  Prakria is a leading React Native app development company that strives to create feature-rich, safe, and scalable React Native apps that function flawlessly on both the iOS and Android platforms. In the USA and India, we provide expert React Native app development services. With the necessary experience and technological know-how, our team of React Native app developers can make your vision a reality.
                  <br></br>
                  One of the most reputable React Native development companies in the USA and India, Prakria is known for producing business-enhancing applications that function flawlessly across several platforms (iOS and Android). Our talented and knowledgeable team of React Native developers is excellent at creating apps with near-native features that need less time and effort to develop.  
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="service-details-img">
                  <img
                    src="/assets/img/innerservices/mobile-app-development/react-native-app-development/1.jpg"
            ...
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-6">
                <div className="service-details-faq-img">
                  <img
                    src="/assets/img/innerservices/mobile-app-development/react-native-app-development/2.jpg"
                    alt="ai & ml development"
                  />
                </div>
              </div>
