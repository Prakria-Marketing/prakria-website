            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                  Wearable Mobile<span>App Development.</span>
                  </h2>
                  <h6>Select a skilled group of professionals to create wearable applications.</h6>
                  <p>
                  The app development industry now has a new platform thanks to wearable technology, which enables various companies and sectors to adapt to the newest trends and satisfy the constantly rising demands of their clientele. As a top wearable app development company in the UK, USA, India, and UAE, Prakria provides our clients with long-term solutions. In a short amount of time, we became visionaries' futuristic technological collaborators, catering to their needs and developing entirely new wearable app development services. Our specially designed app solutions for popular gadgets can assist your particular company in streamlining its operations to increase productivity and elevate the user experience to the highest level possible.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="service-details-img">
                  <img
                    src="/assets/img/innerservices/mobile-app-development/wearable-mobile-app-development/1.jpg"
            ...
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-6">
                <div className="service-details-faq-img">
                  <img
                    src="/assets/img/innerservices/mobile-app-development/wearable-mobile-app-development/2.jpg"
                    alt="ai & ml development"
                  />
                </div>
              </div>
...
export const metadata = {
  title: "Wearable Mobile App Development Services - Prakria Tech",
  description:
    "Innovate with our wearable mobile app development services. Create cutting-edge apps for smartwatches, fitness trackers, and other wearable devices.",
};