            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                  Unity Game<span> Development.</span>
                  </h2>
                  <p>
                  Leading Unity Game Development Firm<br></br><br></br>
With more than 12 years of expertise in the game production business, Prakria is a top Unity game development firm. Our expertise lies in creating captivating and superior 2D and 3D games with the Unity engine. Our elite Unity game developers have extensive expertise and remarkable abilities to create native and cross-platform competitive Unity 2D and 3D games.
<br></br><br></br>
Unity game development services<br></br><br></br>
Our team has created games in a variety of genres, including strategy, multiplayer, action, massively multiplayer online role-playing, and virtual reality (AR/VR), utilizing the Unity3D engine. Our in-house game development team has a track record of successfully releasing graphically captivating, cohesive games. Our Unity 3D game developers build engaging games for clients in the US, UK, Canada, Europe, and India.
                  </p>
                </div>
              </div>
              <div
