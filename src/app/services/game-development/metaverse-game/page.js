            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                    Metaverse Game<span> Development.</span>
                  </h2>
                  <p>
                    The most reputable Metaverse game creation firm, Prakria,
                    has extensive expertise in blockchain, AI, ML, VR, AR, and
                    WebGL technologies. These technologies are used by our
                    skilled Metaverse developers to create incredibly realistic,
                    scalable, and entertaining games that offer a pleasurable
                    and immersive experience.<br></br>
                    <br></br>
                    PRAKRIA: One of the Leading Companies for Developing
                    Metaverse Games<br></br>
                    The Americas, Europe, the UK, and India are served by
                    Prakria, a custom metaverse development business. Like Chain
                    of Alliance, Decentraland, Sandbox, Illuvium, and My
                    Neighbor Alice, we pledge to make the greatest metaverse
                    games ever. To create very creative and compelling metaverse
                    games, our metaverse game developers carefully consider each
                    game element as well as your unique requirements.
                  </p>
                </div>
              </div>
              <div
