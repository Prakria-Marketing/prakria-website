...
function UnrealGameDevelopment() {
  return (
    <MainLayout>
      <div
            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                  Unreal Game<span>App Development.</span>
                  </h2>
                  <p>
                  We are an Unreal game development studio with a staff of professionals who have handled projects in a variety of genres. We create games for multiple platforms. With features that top the industry, Juego Studios produces high-caliber games for its customers quickly. We build captivating gaming experiences with smooth framerates and high-fidelity images by utilizing UE5's powerful capabilities and toolkits.<br></br>
We create top-notch Android, iOS, and cross-platform games in a variety of genres, including action, racing, simulation, role-playing, strategy, and more. We are a top Unreal game production company in the USA and India. Using state-of-the-art tools and technologies, our team of talented game developers has years of expertise creating outstanding and fascinating Unreal games. 
