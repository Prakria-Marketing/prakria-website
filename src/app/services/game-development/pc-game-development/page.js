            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                  PC Game<span>Development.</span>
                  </h2>
                  <p>
                  The best PC game creation firm, Prakria, specializes in creating realistic PC games with cutting-edge features. Our game development professionals create and build PC games for Fortune 500 organizations, startups, and mid-sized firms in Europe, the USA, the UK, and India using the newest technology and tools.<br></br><br></br>
Services We Provide for Desktop Game Development<br></br>
Offering the most engaging and captivating gaming experience, we are the most renowned and elite desktop game development company in the USA and India. Our group of skilled professionals can turn a simple notion into an engaging game that captivates players and keeps them playing for hours on end.<br></br><br></br>
We use the newest technology in gaming to create a PC game with captivating gameplay and stunning graphics. Our goal is to create games that gamers enjoy.
              ...
              >
                <div className="service-details-img">
                  <img
                    src="/assets/img/innerservices/pc-game-development/1.jpg"
            ...
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-6">
                <div className="service-details-faq-img">
                  <img
                    src="/assets/img/innerservices/pc-game-development/2.jpg"
                    alt="ai & ml development"
                  />
                </div>
              </div>
