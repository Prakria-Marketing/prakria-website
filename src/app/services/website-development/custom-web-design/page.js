            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  ...
                  <p>
                  There are many possibilities for template-based websites accessible today; all you have to do to make it uniquely yours at a little expense is purchase a theme, cut and paste your text, and add your logo. Why then, is custom web design necessary? Because only a custom-designed website can satisfy all of your needs for an exceptionally functional, visually stunning, highly responsive, and scalable website that represents your genuine brand identity, draws users in with an easy-to-use interface, and enhances the reputation of your company. You need to work with an experienced web design company like Prakria to create a custom-made website that complements the distinctiveness of your business with its own style and functionality.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="service-details-img">
                  <img
                    src="/assets/img/innerservices/website-development/custom-web-design/1.jpg"
            ...
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-6">
                <div className="service-details-faq-img">
                  <img
                    src="/assets/img/innerservices/website-development/custom-web-design/2.jpg"
                    alt="ai & ml development"
                  />
                </div>
              </div>
