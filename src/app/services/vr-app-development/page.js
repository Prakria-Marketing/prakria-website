            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  <h2>
                    VR App <span>Development.</span>
                  </h2>
                  <p>
                    Do you need a competent virtual reality app development
                    company in India? Prakria is one of the best in the
                    business, with a large team of innovators that work in both
                    artificial intelligence (AI) and virtual reality (VR). Being
                    the top VR app development company in India, Prakria
                    provides businesses and startups with a wide range of
                    services for all VR platforms, including Oculus, Hololens,
                    HTC Vive, and many more. having vast experience combining
                    verticals with great potential.
                  </p>
