            ...
            <div className="row g-lg-4 gy-5 align-items-center">
              ...
              >
                <div className="service-details-top-content">
                  ...
                  <p>
                    At Prakria, our all-inclusive development and operational
                    services enable startups and large organizations to create
                    ...
                    and assistance. Utilizing cutting-edge DevOps tools, cloud
                    infrastructure, and end-to-end processes, our DevOps
                    services organization adds value throughout the whole
                    product lifecycle.
                    <br></br>
                  </p>
                  ...
                  <div className="accordion" id="accordionTravel">
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingTwo">
                        ...
                        >
                          02. What are common DevOps practices?
                        </button>
                      </h2>
                      <div
                        id="faqcollapseTwo"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingThree">
                        ...
                        >
                          03. Which tools are essential for DevOps?
                        </button>
                      </h2>
                      <div
                        id="faqcollapseThree"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingFour">
                        ...
                        >
                          04. How does DevOps benefit a business?
                        </button>
                      </h2>
                      <div
                        id="faqcollapseFour"
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingFive">
                        ...
                        >
                          05. What skills are important for a DevOps engineer?
                        </button>
                      </h2>
                      <div
                        id="faqcollapseFive"
